...
/**********
 * TODO:
 * Add definition for $baseDir = pwd and $outdir = pwd/output_{some job ID}
 * Duplicated TRIMMOMATIC and adapters parameters. (currently unused)
 * Implement check for pre-existing files for Part 1.(see pipe.sh)
  **********/
...
process '2A_bwa_mem_alignment' {
  ...
  **********/
  ...
  /**********
  * Note:
  * End of pipe.sh, next step begins pipe2.sh
  **********/
